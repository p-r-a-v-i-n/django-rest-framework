...
@unittest.skipUnless(
    "guardian" in settings.INSTALLED_APPS, "django-guardian not installed"
)
...
class PermissionsCompositionTests(TestCase):
    ...
    def test_operand_holder_hash_same_for_same_operands_and_operator(self):
        first_operand_holder = permissions.IsAuthenticated & permissions.IsAdminUser
        second_operand_holder = permissions.IsAuthenticated & permissions.IsAdminUser
    ...
    def test_operand_holder_hash_differs_for_different_operands(self):
        first_operand_holder = permissions.IsAuthenticated & permissions.IsAdminUser
        second_operand_holder = permissions.AllowAny & permissions.IsAdminUser
        third_operand_holder = permissions.IsAuthenticated & permissions.AllowAny
    ...
    def test_filtering_permissions(self):
        ...
        filtered_permissions = [perm for perm in dict.fromkeys(unfiltered_permissions)]
