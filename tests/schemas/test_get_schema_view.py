...
class GetSchemaViewTests(TestCase):
    ...
    def test_openapi(self):
        ...
        assert isinstance(
            schema_view.initkwargs["schema_generator"], openapi.SchemaGenerator
        )
    ...
    def test_coreapi(self):
        with override_settings(
            ...
            assert isinstance(
                schema_view.initkwargs["schema_generator"], coreapi.SchemaGenerator
            )
            assert (
                renderers.CoreAPIOpenAPIRenderer in schema_view.cls().renderer_classes
            )
