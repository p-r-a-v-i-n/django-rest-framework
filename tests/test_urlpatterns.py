...
class FormatSuffixTests(TestCase):
    ...
    def test_included_urls_mixed(self):
        ...
        test_paths = [
            ...
            URLTestPath(
                "/pre_path/87/path/42.api",
                (),
                {"parent": "87", "child": 42, "foo": "bar", "format": "api"},
            ),
            URLTestPath(
                "/pre_path/87/path/42.asdf",
                (),
            ...
            URLTestPath(
                "/ppath/87/re_path/42.api",
                (),
                {"parent": 87, "child": "42", "foo": "bar", "format": "api"},
            ),
            URLTestPath(
                "/ppath/87/re_path/42.asdf",
                (),
                {"parent": 87, "child": "42", "foo": "bar", "format": "asdf"},
            ),
            ...
            URLTestPath(
                "/pre_path/87/re_path/42.api",
                (),
                {"parent": "87", "child": "42", "foo": "bar", "format": "api"},
            ),
            URLTestPath(
                "/pre_path/87/re_path/42.asdf",
                (),
                {"parent": "87", "child": "42", "foo": "bar", "format": "asdf"},
            ),
        ]
